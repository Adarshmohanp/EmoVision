...
# MediaPipe module reference (not instance)
mp_face_detection = mp.solutions.face_detection

def generate_frames(camera_active):
    # Initialize MediaPipe face detection for this generator session
                ...
                if results.detections:
                    for detection in results.detections:
                        ...
                        try:
                            ...
                            # Get most common emotion and its average confidence
                            ...
                            cv2.putText(frame, f"{common_emotion}: {avg_confidence:.1f}%", 
